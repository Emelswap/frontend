      ...
      <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] text-white p-4">
        <div className="max-w-md w-full bg-red-900/20 border border-red-500/50 p-6 rounded-2xl text-center shadow-lg">
          ...
          <p className="text-gray-300 text-sm mb-4">
            Could not initialize the Privy provider. Please add your Privy App ID to <code className="bg-black/50 px-2 py-1 rounded text-red-300">.env.local</code> as <code className="bg-black/50 px-2 py-1 rounded text-red-300">NEXT_PUBLIC_PRIVY_APP_ID</code> and restart the development server.
          </p>
        </div>
      </div>
    );
